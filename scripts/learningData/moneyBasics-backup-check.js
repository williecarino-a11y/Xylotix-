          ...
          contentBlocks: [
            {
              ...
              data: {
                text:
                  'Financial vocabulary is more than memorizing definitions. These concepts explain how money enters your life, how it leaves, what builds financial strength, what creates financial pressure, and why people can earn good money yet still end up broke. Understanding these terms gives you a practical framework for making better financial decisions.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Income — The Money and Value You Receive'
              }
            },

            {
              ...
              data: {
                text:
                  'Income is money or economic value you receive from work, business activity, investments, property, or other legitimate sources. Income is the fuel that enters your financial system, but earning more does not automatically make you wealthy. What matters is what happens to that income after it arrives.'
              }
            },

            {
              ...
              type: 'example',
              data: {
                title: 'Income Example',
                text:
                  'Two people each receive $4,000 per month. One spends $3,800 on lifestyle costs and debt payments. The other spends $2,500 and directs the difference toward savings, investing, and useful assets. They have the same income, but they are building very different financial futures.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Expenses — Where Your Money Goes'
              }
            },

            {
              ...
              data: {
                text:
                  'An expense is money you give up to obtain a good, service, experience, or other benefit. Housing, food, transportation, education, communication, healthcare, entertainment, and subscriptions can all be expenses. Expenses are not automatically bad. The danger begins when spending consistently consumes more of your resources than your financial position can safely support.'
              }
            },

            {
              ...
              data: {
                variant: 'warning',
                title: 'High Income Can Still End in Financial Stress',
                text:
                  'A person can increase income and still remain financially weak if expenses and debt payments rise just as quickly. Financial progress is not simply about earning more. It is also about controlling what leaves your financial system and directing resources toward stronger financial foundations.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Assets — Resources That Hold or Create Economic Value'
              }
            },

            {
              ...
              data: {
                text:
                  'An asset is a resource with measurable economic value that you own or have a legitimate claim to, and that can provide present or future financial benefit. Strong examples include cash, savings, productive investments, ownership in a profitable business, intellectual property, and property that has economic value. An asset is not simply anything you possess. Its economic value, ownership rights, usefulness, income-producing potential, liquidity, costs, and risks all matter.'
              }
            },

            {
              ...
              data: {
                variant: 'info',
                title: 'Important Asset Distinction',
                text:
                  'A thing can be valuable and still require careful financial analysis. A house you own can be an asset because it has economic value. A mortgage used to finance that house is not the asset; the mortgage is a liability. The asset and the debt connected to it are separate parts of the financial picture.'
              }
            },

            {
              ...
              data: {
                title: 'Asset Example',
                text:
                  'Suppose you own a property worth $200,000 and owe $150,000 on its mortgage. The property is an asset because it has economic value and belongs to you. The $150,000 mortgage is a liability because it is an obligation you must repay. Looking only at the property value would hide the debt attached to it.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Liabilities — Claims Against Your Future Resources'
              }
            },

            {
              ...
              data: {
                text:
                  'A liability is a present financial obligation that requires future payment, settlement, or economic sacrifice. Loans, credit-card balances, mortgages, unpaid bills, and money owed to another party can all be liabilities. Liabilities matter because they place claims on future income or other resources. A person may look wealthy because of what they own while actually being financially fragile because of what they owe.'
              }
            },

            {
              ...
              data: {
                variant: 'warning',
                title: 'Do Not Judge Wealth by Appearance',
                text:
                  'A luxury car, large house, expensive phone, or designer lifestyle does not automatically mean financial strength. If large liabilities are attached to those possessions, much of the apparent wealth may be financed by debt. Always look at both what is owned and what is owed.'
              }
            },

            {
              ...
              data: {
                ...
                text:
                  'Someone owns a car worth $40,000 but owes $35,000 on the vehicle loan. The car is an asset, while the $35,000 loan is a liability. The person does not have $40,000 of debt-free wealth simply because the car is worth $40,000.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Debt — Borrowing From Your Future'
              }
            },

            {
              ...
              data: {
                text:
                  'Debt is money borrowed that creates a contractual obligation to repay. Debt can sometimes be useful when it helps acquire education, productive assets, or a business opportunity that creates sufficient value to justify its cost. But debt is never free. Interest, fees, repayment requirements, and the risk of losing income can turn borrowing into a serious financial burden.'
              }
            },

            {
              ...
              data: {
                variant: 'warning',
                title: 'Debt Can Consume Your Future Income',
                text:
                  'Every major debt payment represents part of your future resources already committed to a past decision. Before borrowing, ask how much you will repay in total, how long repayment will last, what interest and fees will cost, and whether you could still manage the payments if your income falls.'
              }
            },

            {
              ...
              data: {
                title: 'Debt Example',
                text:
                  'Someone borrows $10,000 and focuses only on the $10,000 received. But if interest and fees cause the total repayment to become $13,000, the borrowing decision has created a $13,000 financial commitment. The amount received is not the same as the true cost of the debt.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'Net Worth — What Remains After What You Owe'
              }
            },

            {
              ...
              data: {
                text:
                  'Net worth gives a simplified picture of financial position by comparing assets with liabilities. The basic relationship is: Net Worth = Assets − Liabilities. This helps reveal why owning expensive things does not automatically make someone wealthy.'
              }
            },

            {
              ...
              type: 'example',
              data: {
                title: 'Net Worth Example',
                text:
                  'If your assets are worth $100,000 and your liabilities total $40,000, your simplified net worth is $60,000. If your assets remain at $100,000 but your liabilities rise to $80,000, your simplified net worth falls to $20,000.'
              }
            },
...

            {
              ...
              data: {
                text:
                  'Cash flow describes money moving into and out of your financial system over time. A simple personal framework is: Net Cash Flow = Income − Expenses. Positive cash flow means more money came in than went out. Negative cash flow means more money went out than came in. Debt payments and other obligations can strongly affect cash flow.'
              }
            },
...

            {
              ...
              data: {
                text:
                  'A budget is a deliberate plan for allocating available financial resources. It helps you decide what portion of your money should go toward essential expenses, personal enjoyment, saving, investing, debt repayment, and future goals. A budget is not about refusing to enjoy life. It is about making sure today’s choices do not quietly destroy tomorrow’s financial position.'
              }
            },

            {
              ...
              data: {
                level: 2,
                text: 'How These Concepts Work Together'
              }
            },

            {
              ...
              data: {
                text:
                  'Income brings resources into your financial system. Expenses take resources out. Assets represent resources with economic value. Liabilities represent obligations against future resources. Debt is a common form of liability. Cash flow shows what is happening to money over time. Net worth compares assets with liabilities. A budget helps you control how your resources are allocated.'
              }
            },

            {
              ...
              data: {
                variant: 'warning',
                title: 'The Financial Framework to Remember',
                text:
                  'Income − Expenses = Net Cash Flow. Assets − Liabilities = Net Worth. A person can have high income but weak cash flow. A person can own expensive assets but have large liabilities. Financial strength comes from understanding the entire picture, not judging your finances by income, possessions, or lifestyle alone.'
              }
            },

            {
              ...
              data: {
                title: 'Lesson Summary',
                points: [
                  'Income is the money or economic value you receive.',
                  'Expenses are resources you give up for goods, services, experiences, or other benefits.',
                  'Assets are resources with economic value that can provide present or future financial benefit.',
                  'A house can be an asset, while the mortgage used to finance it is a liability.',
                  'Liabilities are financial obligations that place claims on future resources.',
                  'Debt is borrowed money that creates an obligation to repay.',
                  'High income does not automatically create wealth.',
                  'Expensive possessions do not automatically mean financial strength.',
                  'Net worth can be simplified as Assets − Liabilities.',
                  'Net cash flow can be simplified as Income − Expenses.',
                  'A budget helps direct money intentionally instead of allowing spending to happen without a plan.'
                ]
              }
            }
          ],
          ...
          quizzes: [
            {
              ...
              options: [
                'A resource with economic value that can provide present or future financial benefit',
                'Any item that a person purchases',
                'Money borrowed from a lender',
                'A payment that must be made in the future'
              ],
              correctAnswer: 0,
              explanation:
                'An asset is a resource with economic value that is owned or legitimately controlled and can provide present or future financial benefit.',
              points: 10
            },

            {
              ...
              questionType: 'multiple-choice',
              question:
                'Which statement correctly distinguishes a house from its mortgage?',
              options: [
                'The house is the liability and the mortgage is the asset',
                'Both are automatically assets',
                'The house can be an asset while the mortgage is a liability',
                'Neither has financial relevance'
              ],
              correctAnswer: 2,
              explanation:
                'The property can have economic value and therefore be an asset, while the mortgage represents an obligation to repay and is therefore a liability.',
              points: 10
            },

            {
              ...
              questionType: 'multiple-choice',
              question:
                'Why can a person with a high income still become financially stressed?',
              options: [
                'Income automatically creates debt',
                'Expenses, debt payments, and other obligations can consume most of the income',
                'Assets disappear when income increases',
                'High income prevents saving'
              ],
              correctAnswer: 1,
              explanation:
                'High income does not guarantee financial strength. Spending and debt obligations can consume most of the resources received.',
              points: 10
            },

            {
              ...
              correctAnswer: 1,
              explanation:
                'Simplified net worth is calculated by subtracting liabilities from assets.',
              points: 10
            },

            {
              ...
              correctAnswer: 1,
              explanation:
                'The person may also have substantial liabilities. Financial strength must be considered using the broader relationship between assets, liabilities, income, expenses, and cash flow.',
              points: 10
            },

            {
              ...
              questionType: 'multiple-choice',
              question:
                'What should someone evaluate before taking on significant debt?',
              options: [
                'Only the amount of money received',
                'Only whether the purchase looks impressive',
                'Total repayment cost, interest, fees, payment burden, purpose, and ability to handle income changes',
                'Whether friends and family are also borrowing'
              ],
              correctAnswer: 2,
              explanation:
                'Responsible borrowing requires evaluating the complete cost and repayment burden, not just the amount initially received.',
              points: 10
            },

            {
              ...
              questionType: 'true-false',
              question:
                'Debt is always financially harmful regardless of its purpose and cost.',
              options: [
                'True',
                'False'
              ],
              correctAnswer: 1,
              explanation:
                'Debt should always be evaluated carefully, but its financial effect depends on its purpose, cost, repayment burden, risks, and the borrower’s circumstances.',
              points: 10
            }
          ]
        },
